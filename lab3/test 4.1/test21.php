        ...
        <div class="card">
            ...
            <div class="code-block">
                ...
                <div style="margin-top: 12px;">
                    <span class="badge" style="background:#fce8e6; color:#c5221f;">\d+</span>
                    <span style="color:#5f6368; margin-left:8px;">— одна или более цифр</span>
                </div>
            </div>
            ...
            <div class="function-block">
                ...
                <div style="margin-top: 16px; color:#5f6368;">
                    ...
                    Возводит каждое найденное число в квадрат
                </div>
            </div>
